...
<html>
  ...
  <head>
    ...
    <style>
      ...
      0 0 #e6e6e6,-1px 0 0 #e6e6e6,0 1px 0 #e6e6e6,0 -1px 0 #e6e6e6,0 3px 13px
      rgba(0,0,0,0.08);box-shadow:1px 0 0 #e6e6e6,-1px 0 0 #e6e6e6,0 1px 0 #e6e6e6,0
      -1px 0 #e6e6e6,0 3px 13px rgba(0,0,0,0.08);}.flatpickr-calendar.open,.flatpickr-calendar.inline{opacity:1;max-height:640px;visibility:visible}.flatpickr-calendar.open{display:inline-block;z-index:100000}.flatpickr-calendar.animate.open{-webkit
      - animation:fpFadeInDown 300ms cubic-bezier(.23,1,.32,1);animation:fpFadeInDown
      300ms cubic-bezier(.23,1,.32,1)}.flatpickr-calendar.inline{display:block;position:relative;top:2px}.flatpickr-calendar.static{position:absolute;top:calc(100%
      + 2px);}.flatpickr-calendar.static.open{z - index:999;display:block}.flatpickr-calendar.multiMonth
      .flatpickr-days .dayContainer:nth-child(n+1) .flatpickr-day.inRange:nth-child(7n+7){-webkit
      - box - shadow:none !important;box-shadow:none !important}.flatpickr-calendar.multiMonth
      .flatpickr-days .dayContainer:nth-child(n+2) .flatpickr-day.inRange:nth-child(7n+1){-webkit
      - box - shadow:-2px 0 0 #e6e6e6,5px 0 0 #e6e6e6;box-shadow:-2px 0 0 #e6e6e6,5px
      0 0 #e6e6e6}.flatpickr-calendar .hasWeeks .dayContainer,.flatpickr-calendar
      .hasTime .dayContainer{border - bottom:0;border-bottom-right-radius:0;border-bottom-left-radius:0}.flatpickr-calendar
      .hasWeeks .dayContainer{border - left:0}.flatpickr-calendar.showTimeInput.hasTime
      .flatpickr-time{height:40px;border-top:1px solid #e6e6e6}.flatpickr-calendar.noCalendar.hasTime
      ...
      transparent;content:'';height:0;width:0;left:22px}.flatpickr-calendar.rightMost:before,.flatpickr-calendar.rightMost:after{left:auto;right:22px}.flatpickr-calendar:before{border
      - width:5px;margin:0 -5px}.flatpickr-calendar:after{border - width:4px;margin:0
      -4px}.flatpickr-calendar.arrowTop:before,.flatpickr-calendar.arrowTop:after{bottom:100%}.flatpickr-calendar.arrowTop:before{border
      - bottom - color:#e6e6e6}.flatpickr-calendar.arrowTop:after{border - bottom
      - color:#fff}.flatpickr-calendar.arrowBottom:before,.flatpickr-calendar.arrowBottom:after{top:100%}.flatpickr-calendar.arrowBottom:before{border
      - top - color:#e6e6e6}.flatpickr-calendar.arrowBottom:after{border - top
      - color:#fff}.flatpickr-calendar:focus{outline:0}.flatpickr-wrapper{position:relative;display:inline-block}.flatpickr-months{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;}.flatpickr-months
      ...
      .flatpickr-prev-month,.flatpickr-months .flatpickr-next-month{text - decoration:none;cursor:pointer;position:absolute;top:0;line-height:16px;height:28px;padding:10px;z-index:3;color:rgba(0,0,0,0.9);fill:rgba(0,0,0,0.9);}.flatpickr-months
      .flatpickr-prev-month.disabled,.flatpickr-months .flatpickr-next-month.disabled{display:none}.flatpickr-months
      .flatpickr-prev-month i,.flatpickr-months .flatpickr-next-month i{position:relative}.flatpickr-months
      .flatpickr-prev-month.flatpickr-prev-month,.flatpickr-months .flatpickr-next-month.flatpickr-prev-month{/*
      /*rtl:begin:ignore*/left:0;/* /*rtl:end:ignore*/}/* /*rtl:begin:ignore*//*
      /*rtl:end:ignore*/.flatpickr-months .flatpickr-prev-month.flatpickr-next-month,.flatpickr-months
      .flatpickr-next-month.flatpickr-next-month{/* /*rtl:begin:ignore*/right:0;/*
      /*rtl:end:ignore*/}/* /*rtl:begin:ignore*//* /*rtl:end:ignore*/.flatpickr-months
      .flatpickr-prev-month:hover,.flatpickr-months .flatpickr-next-month:hover{color:#959ea9;}.flatpickr-months
      .flatpickr-prev-month:hover svg,.flatpickr-months .flatpickr-next-month:hover
      svg{fill:#f64747}.flatpickr-months .flatpickr-prev-month svg,.flatpickr-months
      .flatpickr-next-month svg{width:14px;height:14px;}.flatpickr-months .flatpickr-prev-month
      svg path,.flatpickr-months .flatpickr-next-month svg path{-webkit - transition:fill
      .1s;transition:fill .1s;fill:inherit}.numInputWrapper{position:relative;height:auto;}.numInputWrapper
      input,.numInputWrapper span{display:inline-block}.numInputWrapper input{width:100%;}.numInputWrapper
      input::-ms-clear{display:none}.numInputWrapper input::-webkit-outer-spin-button,.numInputWrapper
      input::-webkit-inner-spin-button{margin:0;-webkit-appearance:none}.numInputWrapper
      span{position:absolute;right:0;width:14px;padding:0 4px 0 2px;height:50%;line-height:50%;opacity:0;cursor:pointer;border:1px
      solid rgba(57,57,57,0.15);-webkit-box-sizing:border-box;box-sizing:border-box;}.numInputWrapper
      ...
      solid rgba(57,57,57,0.6);top:26%}.numInputWrapper span.arrowDown{top:50%;}.numInputWrapper
      span.arrowDown:after{border - left:4px solid transparent;border-right:4px
      solid transparent;border-top:4px solid rgba(57,57,57,0.6);top:40%}.numInputWrapper
      span svg{width:inherit;height:auto;}.numInputWrapper span svg path{fill:rgba(0,0,0,0.5)}.numInputWrapper:hover{background:rgba(0,0,0,0.05);}.numInputWrapper:hover
      span{opacity:1}.flatpickr-current-month{font - size:135%;line-height:inherit;font-weight:300;color:inherit;position:absolute;width:75%;left:12.5%;padding:6.16px
      0 0 0;line-height:1;height:28px;display:inline-block;text-align:center;-webkit-transform:translate3d(0,0,0);transform:translate3d(0,0,0);}.flatpickr-current-month
      span.cur-month{font - family:inherit;font-weight:700;color:inherit;display:inline-block;margin-left:.5ch;padding:0;}.flatpickr-current-month
      span.cur-month:hover{background:rgba(0,0,0,0.05)}.flatpickr-current-month
      .numInputWrapper{width:6ch;width:7ch\0;display:inline-block;}.flatpickr-current-month
      .numInputWrapper span.arrowUp:after{border - bottom - color:rgba(0,0,0,0.9)}.flatpickr-current-month
      .numInputWrapper span.arrowDown:after{border - top - color:rgba(0,0,0,0.9)}.flatpickr-current-month
      input.cur-year{background:transparent;-webkit-box-sizing:border-box;box-sizing:border-box;color:inherit;cursor:text;padding:0
      0 0 .5ch;margin:0;display:inline-block;font-size:inherit;font-family:inherit;font-weight:300;line-height:inherit;height:auto;border:0;border-radius:0;vertical-align:initial;-webkit-appearance:textfield;-moz-appearance:textfield;appearance:textfield;}.flatpickr-current-month
      input.cur-year:focus{outline:0}.flatpickr-current-month input.cur-year[disabled],.flatpickr-current-month
      input.cur-year[disabled]:hover{font - size:100%;color:rgba(0,0,0,0.5);background:transparent;pointer-events:none}.flatpickr-weekdays{background:transparent;text-align:center;overflow:hidden;width:100%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;height:28px;}.flatpickr-weekdays
      ...
      + .dayContainer{-webkit - box - shadow:-1px 0 0 #e6e6e6;box-shadow:-1px
      0 0 #e6e6e6}.flatpickr-day{background:none;border:1px solid transparent;border-radius:150px;-webkit-box-sizing:border-box;box-sizing:border-box;color:#393939;cursor:pointer;font-weight:400;width:14.2857143%;-webkit-flex-basis:14.2857143%;-ms-flex-preferred-size:14.2857143%;flex-basis:14.2857143%;max-width:39px;height:39px;line-height:39px;margin:0;display:inline-block;position:relative;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;text-align:center;}.flatpickr-day.inRange,.flatpickr-day.prevMonthDay.inRange,.flatpickr-day.nextMonthDay.inRange,.flatpickr-day.today.inRange,.flatpickr-day.prevMonthDay.today.inRange,.flatpickr-day.nextMonthDay.today.inRange,.flatpickr-day:hover,.flatpickr-day.prevMonthDay:hover,.flatpickr-day.nextMonthDay:hover,.flatpickr-day:focus,.flatpickr-day.prevMonthDay:focus,.flatpickr-day.nextMonthDay:focus{cursor:pointer;outline:0;background:#e6e6e6;border-color:#e6e6e6}.flatpickr-day.today{border
      - color:#959ea9;}.flatpickr-day.today:hover,.flatpickr-day.today:focus{border
      - color:#959ea9;background:#959ea9;color:#fff}.flatpickr-day.selected,.flatpickr-day.startRange,.flatpickr-day.endRange,.flatpickr-day.selected.inRange,.flatpickr-day.startRange.inRange,.flatpickr-day.endRange.inRange,.flatpickr-day.selected:focus,.flatpickr-day.startRange:focus,.flatpickr-day.endRange:focus,.flatpickr-day.selected:hover,.flatpickr-day.startRange:hover,.flatpickr-day.endRange:hover,.flatpickr-day.selected.prevMonthDay,.flatpickr-day.startRange.prevMonthDay,.flatpickr-day.endRange.prevMonthDay,.flatpickr-day.selected.nextMonthDay,.flatpickr-day.startRange.nextMonthDay,.flatpickr-day.endRange.nextMonthDay{background:#569ff7;-webkit-box-shadow:none;box-shadow:none;color:#fff;border-color:#569ff7}.flatpickr-day.selected.startRange,.flatpickr-day.startRange.startRange,.flatpickr-day.endRange.startRange{border
      - radius:50px 0 0 50px}.flatpickr-day.selected.endRange,.flatpickr-day.startRange.endRange,.flatpickr-day.endRange.endRange{border
      - radius:0 50px 50px 0}.flatpickr-day.selected.startRange + .endRange:not(:nth-child(7n+1)),.flatpickr-day.startRange.startRange
      + .endRange:not(:nth-child(7n+1)),.flatpickr-day.endRange.startRange +
      .endRange:not(:nth-child(7n+1)){-webkit - box - shadow:-10px 0 0 #569ff7;box-shadow:-10px
      0 0 #569ff7}.flatpickr-day.selected.startRange.endRange,.flatpickr-day.startRange.startRange.endRange,.flatpickr-day.endRange.startRange.endRange{border
      - radius:50px}.flatpickr-day.inRange{border - radius:0;-webkit-box-shadow:-5px
      0 0 #e6e6e6,5px 0 0 #e6e6e6;box-shadow:-5px 0 0 #e6e6e6,5px 0 0 #e6e6e6}.flatpickr-day.disabled,.flatpickr-day.disabled:hover,.flatpickr-day.prevMonthDay,.flatpickr-day.nextMonthDay,.flatpickr-day.notAllowed,.flatpickr-day.notAllowed.prevMonthDay,.flatpickr-day.notAllowed.nextMonthDay{color:rgba(57,57,57,0.3);background:transparent;border-color:transparent;cursor:default}.flatpickr-day.disabled,.flatpickr-day.disabled:hover{cursor:not-allowed;color:rgba(57,57,57,0.1)}.flatpickr-day.week.selected{border
      - radius:0;-webkit-box-shadow:-5px 0 0 #569ff7,5px 0 0 #569ff7;box-shadow:-5px
      0 0 #569ff7,5px 0 0 #569ff7}.flatpickr-day.hidden{visibility:hidden}.rangeMode
      .flatpickr-day{margin - top:1px}.flatpickr-weekwrapper{display:inline-block;float:left;}.flatpickr-weekwrapper
      .flatpickr-weeks{padding:0 12px;-webkit-box-shadow:1px 0 0 #e6e6e6;box-shadow:1px
      0 0 #e6e6e6}.flatpickr-weekwrapper .flatpickr-weekday{float:none;width:100%;line-height:28px}.flatpickr-weekwrapper
      span.flatpickr-day,.flatpickr-weekwrapper span.flatpickr-day:hover{display:block;width:100%;max-width:none;color:rgba(57,57,57,0.3);background:transparent;cursor:default;border:none}.flatpickr-innerContainer{display:block;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-sizing:border-box;box-sizing:border-box;overflow:hidden;}.flatpickr-rContainer{display:inline-block;padding:0;-webkit-box-sizing:border-box;box-sizing:border-box}.flatpickr-time{text
      - align:center;outline:0;display:block;height:0;line-height:40px;max-height:40px;-webkit-box-sizing:border-box;box-sizing:border-box;overflow:hidden;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;}.flatpickr-time:after{content:"";display:table;clear:both}.flatpickr-time
      .numInputWrapper{-webkit - box - flex:1;-webkit-flex:1;-ms-flex:1;flex:1;width:40%;height:40px;float:left;}.flatpickr-time
      .numInputWrapper span.arrowUp:after{border - bottom - color:#393939}.flatpickr-time
      .numInputWrapper span.arrowDown:after{border - top - color:#393939}.flatpickr-time.hasSeconds
      .numInputWrapper{width:26%}.flatpickr-time.time24hr .numInputWrapper{width:49%}.flatpickr-time
      ...
      input.flatpickr-hour{font - weight:bold}.flatpickr-time input.flatpickr-minute,.flatpickr-time
      input.flatpickr-second{font - weight:400}.flatpickr-time input:focus{outline:0;border:0}.flatpickr-time
      .flatpickr-time-separator,.flatpickr-time .flatpickr-am-pm{height:inherit;display:inline-block;float:left;line-height:inherit;color:#393939;font-weight:bold;width:2%;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-align-self:center;-ms-flex-item-align:center;align-self:center}.flatpickr-time
      .flatpickr-am-pm{outline:0;width:18%;cursor:pointer;text-align:center;font-weight:400}.flatpickr-time
      input:hover,.flatpickr-time .flatpickr-am-pm:hover,.flatpickr-time input:focus,.flatpickr-time
    ...
    <style>
      body{font - family: 'Lato', sans-serif;}.sa-input{box - sizing: border-box;
      width: 100%; outline: none; background-color: #fff; border-radius: 6px;
      border-color: #AEB8C0; border-style: solid; border-width: 1px; background-size:
      16px 16px; height: 32px;}.sa-text{padding: 10px 28px 10px 15px; font-size:
      14px;}.sa-dropdown {height: auto;}.sa-textarea{resize: none; height: auto;
      padding: 10px 28px 10px 15px; font-size: 14px;}.sa-form{position: relative;
      max-width: 1024px; margin: 0 auto; background-color: white;}.sa-form-review{margin:
      0 auto; background-color: white;}.sa-form-body{background - color: white;
      color: black;}.sa-form-field{margin: 24px 2%;}.sa-form-page{padding: 1px
      2px; max-width: 1024px; margin: 0 auto;}.sa-form-page-nav{display: flex;
      flex-direction: row; flex-wrap: wrap; justify-content: space-between; padding-bottom:
      16px; margin: 12px 2%;}.sa-form-page-prev,.sa-form-page-next,.sa-form-page-submit{white
      - space: nowrap; text-align: center; cursor: pointer; filter: brightness(100%);
      width: 200px; min-width: 20%; max-width: 46%; margin-bottom: 10px;}.sa-form-page-prev.disabled,.sa-form-page-next.disabled,.sa-form-page-submit.disabled
      {filter: brightness(50%); cursor: not-allowed;}.sa-calendar-container {min
      - height: 250px;}@media only screen and (max-width: 600px) {.sa-form-page-prev,
      .sa-form-page-next, .sa-form-page-submit {width: 100%; min-width: 50%;
      max-width: 100%;}} .sa-form-page-prev:hover, .sa-form-page-next:hover,
      .sa-form-page-submit:hover {filter: brightness(75%);} .sa-form-page-prev:active,
      .sa-form-page-next:active, .sa-form-page-submit:active {filter: brightness(105%);}.sa-character-counter{display:
      flex; flex-direction: row; justify-content: flex-end;}.sa-character-limit-exceeded
      input,.sa-character-limit-exceeded textarea,.sa-invalid, input[type="hidden"].sa-invalid
      + input[type="date"]{border: 1px solid red; background-color: rgba(255,
      0, 0, 0.1);}.sa-invalid-label {color: red;}.sa-character-limit-exceeded
      label{color: red;}.sa-required::before{content: '* '; color: red;}.sa-input.sa-required::before{position:
      relative; top: -24px; content: '*'; color: red;}/* Radio Buttons */.sa-radio-container{display:
      block; position: relative; padding-left: 12px; margin-bottom: 12px; cursor:
      pointer; font-size: 16px; -webkit-user-select: none; -moz-user-select:
      none; -ms-user-select: none; user-select: none;} /* Hide the browser's
      default radio button */ .sa-radio-container input {position: absolute;
      opacity: 0; cursor: pointer;} .sa-radio-container label {cursor: pointer;}.sa-radio{position:
      absolute; width: 16px; height: 16px; border: 2px solid #777777; border-radius:
      50%; cursor: pointer;}.sa-radio-checkmark{position: absolute; top: 2px;
      left: 2px; width: 12px; height: 12px; border-radius: 50%; content: '';
      display: none;}.sa-radio-container:hover input ~ .sa-radio > .sa-radio-checkmark{background
      - color: #777777; content: ''; display: block;}.sa-radio-container input:checked
      ~ .sa-radio > .sa-radio-checkmark{display: block;}.sa-radio-container .sa-radio-label{margin
      - left: 26px;}/* Checkbox */.sa-checkbox-container{display: block; position:
      relative; padding-left: 12px; margin-bottom: 12px; cursor: pointer; font-size:
      16px; -webkit-user-select: none; -moz-user-select: none; -ms-user-select:
      none; user-select: none;} /* Hide the browser's default checkbox button
      */ .sa-checkbox-container input {position: absolute; opacity: 0; cursor:
      pointer;} .sa-checkbox-container label {cursor: pointer;}/* Create a custom
      checkbox button */.sa-checkbox{position: absolute; width: 16px; height:
      16px; border: 2px solid #777777; border-radius: 25%; cursor: pointer;}.sa-checkbox-checkmark{position:
      absolute; top: 2px; left: 2px; width: 12px; height: 12px; border-radius:
      25%;}.sa-checkbox-checkmark{content: ''; position: absolute; display: none;}.sa-checkbox-container:hover
      input:not(:checked) ~ .sa-checkbox > .sa-checkbox-checkmark{content: '';
      display: block; left: 4px; top: 0px; width: 5px; height: 10px; border:
      solid #777777; border-width: 0 3px 3px 0; -webkit-transform: rotate(45deg);
      -ms-transform: rotate(45deg); transform: rotate(45deg);}.sa-checkbox-container
      input:checked ~ .sa-checkbox > .sa-checkbox-checkmark{display: block; left:
      4px; top: 0px; width: 5px; height: 10px; border: solid white; border-width:
      0 3px 3px 0; -webkit-transform: rotate(45deg); -ms-transform: rotate(45deg);
      transform: rotate(45deg);}.sa-checkbox-container .sa-checkbox-label{margin
      - left: 26px;}/* Themes */.sa-theme0 {background - color: white;}.sa-theme1{background
      - color: #E6F9E6; font-family: Helvetica;}.sa-theme2{background - color:
      #F3F3F3; font-family: 'Times New Roman';}.sa-theme3{background - color:
      #ECF3FC; font-family: Verdana;}.sa-theme4{background - color: #686868;
      font-family: Arial;}.sa-theme5{background - color: #FFF2E5; font-family:
      'Courier New'; font-size: 16px;}.sa-theme6{background - color: #F3E7FE;
      font-family: 'Trebuchet MS'; font-size: 16px;}/* Placeholder Styles */.sa-placeholder-Arial::-webkit-input-placeholder{font
      - family: Arial;}.sa-placeholder-Chalkboard::-webkit-input-placeholder{font
      - family: Chalkboard;}.sa-placeholder-ComicSansMS::-webkit-input-placeholder{font
      - family: 'Comic Sans MS';}.sa-placeholder-CourierNew::-webkit-input-placeholder{font
      - family: 'Courier New';}.sa-placeholder-Georgia::-webkit-input-placeholder{font
      - family: Georgia;}.sa-placeholder-Helvetica::-webkit-input-placeholder{font
      - family: Helvetica;}.sa-placeholder-Impact::-webkit-input-placeholder{font
      - family: Impact;}.sa-placeholder-LucidaSansUnicode::-webkit-input-placeholder{font
      - family: 'Lucida Sans Unicode';}.sa-placeholder-Tahoma::-webkit-input-placeholder{font
      - family: Tahoma;}.sa-placeholder-TimesNewRoman::-webkit-input-placeholder{font
      - family: 'Times New Roman';}.sa-placeholder-TrebuchetMS::-webkit-input-placeholder{font
      - family: 'Trebuchet MS';}.sa-placeholder-Verdana::-webkit-input-placeholder{font
      - family: Verdana;}.sa-placeholder-Arial::-moz-placeholder{font - family:
      Arial;}.sa-placeholder-Chalkboard::-moz-placeholder{font - family: Chalkboard;}.sa-placeholder-ComicSansMS::-moz-placeholder{font
      - family: 'Comic Sans MS';}.sa-placeholder-CourierNew::-moz-placeholder{font
      - family: 'Courier New';}.sa-placeholder-Georgia::-moz-placeholder{font
      - family: Georgia;}.sa-placeholder-Helvetica::-moz-placeholder{font - family:
      Helvetica;}.sa-placeholder-Impact::-moz-placeholder{font - family: Impact;}.sa-placeholder-LucidaSansUnicode::-moz-placeholder{font
      - family: 'Lucida Sans Unicode';}.sa-placeholder-Tahoma::-moz-placeholder{font
      - family: Tahoma;}.sa-placeholder-TimesNewRoman::-moz-placeholder{font
      - family: 'Times New Roman';}.sa-placeholder-TrebuchetMS::-moz-placeholder{font
      - family: 'Trebuchet MS';}.sa-placeholder-Verdana::-moz-placeholder{font
      - family: Verdana;}.sa-placeholder-italic::-webkit-input-placeholder{font
      - style: italic;}.sa-placeholder-bold::-webkit-input-placeholder{font -
      weight: bold}.sa-placeholder-underlined::-webkit-input-placeholder{text
      - decoration: underline;}.sa-placeholder-italic::-moz-placeholder{font
      - style: italic;}.sa-placeholder-bold::-moz-placeholder{font - weight:
      bold}.sa-placeholder-underlined::-moz-placeholder{text - decoration: underline;}.sa-form-divider{padding:
      8px 0;}.sa-form-video {width: 420px; height: 315px;}.sa-form-video-container
      {width: 420px; text-align: center;} .sa-formRating .sa-formRating--Container
      {background - color: #ffffff; border-top: solid 1px #9e9e9e; border-bottom:
      solid 1px #9e9e9e; border-right: solid 1px #9e9e9e; border-left: solid
      1px #9e9e9e; display: flex; flex-direction: column; align-items: center;
      justify-content: space-around;} .sa-invalid-rating .sa-formRating .sa-formRating--Container
      {border: 1px solid red;} .sa-formRating .sa-formRating--Container:not(:checked)
      > input {display: none;} .sa-formRating .sa-formRating--Container .sa-formRating--Container-Link
      {padding: 16px 10px 10px 10px; height: 26px; width: 50px; text-align: center;
      cursor: pointer;}.sa-chooseFile{white - space: nowrap; text-align: center;
      cursor: pointer; padding: 10px 20px; background-color: #E1E1E1; color:
      #1e1e1e; border-radius: 6px; border: none; margin-bottom: 25px; line-height:
      inherit; font-size: 16px;} .sa-chooseFile:hover {background - color: #d1d1d1;
      color: #1e1e1e; border: none;}.sa-fileDiv{padding - top: 15px;}.sa-uploadedFileContainer{margin:
      25px 0;}.sa-uploadedFile{border: 1px solid #C3C3C3; border-radius: 6px;
      box-shadow: 0 0 2px 0 rgba(0,0,0,0.3), 0 2px 2px 0 rgba(0,0,0,0.3); padding:
      10px; margin: 10px 0;} .sa-uploadedFile .sa-uploadedFile--Remove {justify
      - content: flex-end; color: #D0021B; cursor: pointer; align-self: center;}
      .sa-uploadedFile .sa-uploadedFile--FileName {padding - left: 10px;} .sa-uploadedFile
      .sa-uploadedFile--Size {font - size: 12px;}.sa-loadingSpinner{border: 3px
      solid #f3f3f3; border-radius: 50%; border-top: 3px solid #3498db; width:
      10px; height: 10px; animation: sa-loadingSpinner 2s linear infinite;} .sa-loadingSpinner.sa-loadingSpinner-GridRow
      {width: 12px; height: 12px;} .sa-loadingSpinner.sa-loadingSpinner-Inline
      {margin - right: 5px;} .sa-loadingSpinner.sa-loadingSpinner-ActivityTimeline
      {width: 12px; height: 12px; margin-right: 6px;}@-webkit-keyframes sa-loadingSpinner{0
      % { - webkit - transform: rotate(0deg);} 100% {-webkit-transform: rotate(360deg);}}@-moz-keyframes
      sa-loadingSpinner{0 % { - webkit - transform: rotate(0deg);} 100% {-webkit-transform:
      rotate(360deg);}}@keyframes sa-loadingSpinner{0 % { - webkit - transform:
      rotate(0deg);} 100% {-webkit-transform: rotate(360deg);}}.l-SA-FormRating{display:
      flex; flex-direction: row; flex: 0 0 98%; flex-wrap: wrap;}.l-SA-UploadFile{display:
      flex; flex-direction: row; justify-content: space-between; align-items:
      center;}.l-SA-FileName{display: flex; flex-direction: row; justify-content:
      flex-start; align-items: center;}.sa-ico-CircleCheck{background - repeat:
      no-repeat; background-position: center center; display: inline-block; vertical-align:
      middle; width: 24px; height: 24px; background-size: 24px 24px; background-image:
      url(https://my.serviceautopilot.com/v3-images/CircleCheck.svg); filter:
      brightness(0) saturate(100%) invert(43%) sepia(100%) saturate(421%) hue-rotate(97deg)
      brightness(97%) contrast(93%);}.sa-ico-Trashcan{ background-repeat: no-repeat;
      background-position: center center; display: inline-block; vertical-align:
      middle; width: 24px; height: 24px; background-size: 24px 24px; background-image:
      url(https://my.serviceautopilot.com/v3-images/Trashcan.svg); filter: invert(9%)
      sepia(97%) saturate(6260%) hue-rotate(349deg) brightness(90%) contrast(102%);
      /*red*/}.sa-ico-Failed{ background-repeat: no-repeat; background-position:
      center center; display: inline-block; vertical-align: middle; width: 24px;
      height: 24px; background-size: 24px 24px; background-image: url(https://my.serviceautopilot.com/v3-images/void.svg);
      filter: invert(9%) sepia(97%) saturate(6260%) hue-rotate(349deg) brightness(90%)
      contrast(102%); /*red*/}.sa-ico-Processing{ background-repeat: no-repeat;
      background-position: center center; display: inline-block; vertical-align:
      middle; width: 24px; height: 24px; background-size: 24px 24px; background-image:
      url(https://my.serviceautopilot.com/v3-images/Processing.svg); animation-name:
      rotateCounterClockwise; animation-duration: 1.4s; animation-iteration-count:
      infinite; animation-timing-function: linear;}@keyframes rotateCounterClockwise{
      0% { transform: rotate(0deg); } 100% { transform: rotate(-360deg); }} @media
      only screen and (max-width: 767.98px){ .sa-form-video { width: 100%; height:
      245px; } .sa-input-wrapper { width: 100% !important; }}.sa-form-confirmation-message,.sa-submission-progress-box{
      box-shadow: 0 0 2px rgba(0,0,0, 0.4); border-radius: 4px; margin: 10px
      auto; display: flex; align-items: center; justify-content: center; flex-direction:
      column;}.sa-submission-progress-box{ width: calc(100vw - 40px); max-width:
      calc(100% - 40px);}.sa-form-confirmation-message{ background-color: rgb(255,255,255);}.sa-submission-progress-container{
      position: absolute; top: 0; left: 0; z-index: 99999; background-color:
      rgba(1,1,1,0.25); width: 100%; height: 100%;}.sa-form-confirmation-message
      img{ width: 100px; height: 100px;}.sa-form-confirmation-message .sa-form-confirmation-message-content,.sa-submission-progress-box
      .sa-submission-progress-message{ padding: 20px; line-height: 1.5em; max-height:
      90vh; overflow: auto;}@keyframes sa-ellipses-slide-1{ 0% { transform: translateX(32px);
      } 10% { transform: translateX(32px); } 50% { transform: translateX(80px);
      } 90% { transform: translateX(128px); } 100% { transform: translateX(128px);
      }}@keyframes sa-ellipses-slide-2{ 0% { transform: translateX(80px); } 10%
      { transform: translateX(80px); } 50% { transform: translateX(128px); }
      90% { transform: translateX(32px); } 100% { transform: translateX(32px);
      }}@keyframes sa-ellipses-slide-3{ 0% { transform: translateX(128px); }
      10% { transform: translateX(128px); } 50% { transform: translateX(32px);
      } 90% { transform: translateX(80px); } 100% { transform: translateX(80px);
      }}.sa-ellipses{ margin-left: -24px; width: 160px;} .sa-ellipses div { position:
      absolute; transform: translateX(32px) scale(1); width: 12px; height: 12px;
      border-radius: 50%; margin-right: 12px; background-color: white; border:
      1px solid #1e1e1e; } .sa-ellipses div:nth-child(1) { animation: sa-ellipses-slide-1
      1s infinite cubic-bezier(0,0.5,0.5,1); } .sa-ellipses div:nth-child(2)
      { animation: sa-ellipses-slide-2 1s infinite cubic-bezier(0,0.5,0.5,1);
      } .sa-ellipses div:nth-child(3) { animation: sa-ellipses-slide-3 1s infinite
      cubic-bezier(0,0.5,0.5,1); }.sa-ohnohoney-container { padding-left: 20px;
      display: flex; flex-direction: column;}.sa-ohnohoney { opacity: 0; position:
      absolute; top: 0; left: 0; height: 0; width: 0; z-index: -1;}
    </style>
    <style>
    </style>
  </head>
  ...
  <body>
    <div class="sa-form sa-theme1">
      <div data-index="1" class="sa-form-page" style="display:block">
        <div data-page="1" data-field="1" class="sa-form-field" style="font-size:30px">
          <strong>
            <span style="color: rgb(13, 197, 14);">
              Lawn Service (Maintenance) - Service Estimate
            </span>
          </strong>
        </div>
        <div data-page="1" data-field="2" style="padding:0px 0px 0px 0px">
          <div class="sa-form-field sa-form-divider" style="border-bottom-style:dashed;border-bottom-width:3px;border-bottom-color:#1F1F1F">
          </div>
        </div>
        <div data-page="1" data-field="3" class="sa-form-field">
          Welcome to our Lawn Service (Maintenance) Service Estimate page. At Premier
          Landscaping Services, we are dedicated to keeping your lawn green, healthy,
          and vibrant. Please complete the following form to request a customized
          estimate for our lawn maintenance services.
        </div>
        <div data-page="1" data-field="4" class="sa-form-field" style="font-size:30px">
          <strong>
            <span style="color: rgb(13, 197, 14);">
        ...
        <div id="sa-txt-69245409-b6b6-4137-a9c9-68aa0a465c46" data-fieldType="shortText"
        required="" data-page="1" data-field="5" class="sa-form-field">
          <p class="sa-required">
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
                First Name
              </strong>
            </span>
          </p>
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-txt-69245409-b6b6-4137-a9c9-68aa0a465c46-input" type="text"
            value="" required="" data-limit="100" class="sa-input sa-text" style="width:100%">
            <label for="sa-txt-69245409-b6b6-4137-a9c9-68aa0a465c46-input" class="sa-character-counter"
            style="display:none">
              0/100
            </label>
          </div>
        </div>
        <div id="sa-txt-e284bab8-3f91-4e47-8d45-bc0c98ce4b85" data-fieldType="shortText"
        required="" data-page="1" data-field="6" class="sa-form-field">
          <p class="sa-required">
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
                Last Name
          ...
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-txt-e284bab8-3f91-4e47-8d45-bc0c98ce4b85-input" type="text"
            value="" required="" data-limit="100" class="sa-input sa-text" style="width:100%">
            <label for="sa-txt-e284bab8-3f91-4e47-8d45-bc0c98ce4b85-input" class="sa-character-counter"
            style="display:none">
              0/100
            </label>
          </div>
        </div>
        <div id="sa-email-59d6a958-6d92-439c-ae7f-a60ec3b0b302" data-fieldType="email"
        required="" data-page="1" data-field="7" class="sa-form-field">
          <p class="sa-required">
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
                Email
          ...
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-email-59d6a958-6d92-439c-ae7f-a60ec3b0b302-input" type="email"
            pattern="[a-z0-9._%&#x2B;-]&#x2B;@[a-z0-9.-]&#x2B;\.[a-z]{2,3}$" value=""
            data-limit="100" class="sa-input sa-text" style="width:100%">
            <label for="sa-email-59d6a958-6d92-439c-ae7f-a60ec3b0b302-input" class="sa-character-counter"
            style="display:none">
              0/100
            </label>
          </div>
        </div>
        <div id="sa-txt-38e06dbb-6601-4911-a28d-c93820cd7ac6" data-fieldType="shortText"
        required="" data-page="1" data-field="8" class="sa-form-field">
          <p class="sa-required">
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
                Phone Number
          ...
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-txt-38e06dbb-6601-4911-a28d-c93820cd7ac6-input" type="text"
            value="" required="" placeholder="###-###-####" data-limit="20" class="sa-input sa-text sa-placeholder-Helvetica"
            style="width:100%">
            <label for="sa-txt-38e06dbb-6601-4911-a28d-c93820cd7ac6-input" class="sa-character-counter"
            style="display:none">
              0/20
            </label>
          </div>
        </div>
        <div data-fieldType="dropdown" required="" data-page="1" data-field="9"
        class="sa-form-field">
          <p class="sa-required">
            <legend>
              How did you discover Guardian Of Orlando?
            </legend>
          </p>
          <select id="sa-dd-06fb27a9-253c-4d38-8ba4-816551b3654c" class="sa-input sa-text sa-dropdown sa-input-wrapper"
          style="width:30%">
            <option value="-1" disabled="" hidden="" selected="">
            </option>
            <option data-value="3b4c5e7d-0cad-4343-94b3-b20ddb3a58cc" value="3b4c5e7d-0cad-4343-94b3-b20ddb3a58cc">
              Email from Guardian
            </option>
            <option data-value="ccc66f41-fd9c-4676-8eee-6602312672ce" value="ccc66f41-fd9c-4676-8eee-6602312672ce">
              Google, Yahoo Search Engine
            </option>
            <option data-value="366084b6-3d01-4034-826b-3e0bc549bd2f" value="366084b6-3d01-4034-826b-3e0bc549bd2f">
              Instagram Facebook Social Site
            </option>
            <option data-value="75c2076a-9d94-4e1b-9d15-ba7a473a5f97" value="75c2076a-9d94-4e1b-9d15-ba7a473a5f97">
              Post Card or Door Hanger
            </option>
            <option data-value="24f4208d-3300-44b3-8dfe-5d76f06c217c" value="24f4208d-3300-44b3-8dfe-5d76f06c217c">
              Recommended by Friend, Family,
            </option>
          </select>
        </div>
        <div data-page="1" data-field="10" style="padding:0px 0px 0px 0px">
          <div class="sa-form-field sa-form-divider" style="border-bottom-style:dashed;border-bottom-width:3px;border-bottom-color:#1F1F1F">
          </div>
        </div>
        <div data-page="1" data-field="11" class="sa-form-field" style="font-size:30px">
          <span style="color:rgb(13, 197, 14);font-family: Helvetica;">
            <strong>
              Service Address
            </strong>
          </span>
        </div>
        <div id="sa-txt-ec5e70d4-d8f4-4f41-91aa-dcb511bb850b" data-fieldType="shortText"
        required="" data-page="1" data-field="12" class="sa-form-field">
          <p class="sa-required">
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
                Address Line 1
          ...
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-txt-ec5e70d4-d8f4-4f41-91aa-dcb511bb850b-input" type="text"
            value="" required="" data-limit="500" class="sa-input sa-text" style="width:100%">
            <label for="sa-txt-ec5e70d4-d8f4-4f41-91aa-dcb511bb850b-input" class="sa-character-counter"
            style="display:none">
              0/500
            </label>
          </div>
        </div>
        <div id="sa-txt-ec1d1f07-9f16-4bc0-b41c-81194d82f2dc" data-fieldType="shortText"
        data-page="1" data-field="13" class="sa-form-field">
          <p>
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
                Address Line 2
          ...
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-txt-ec1d1f07-9f16-4bc0-b41c-81194d82f2dc-input" type="text"
            value="" data-limit="500" class="sa-input sa-text" style="width:100%">
            <label for="sa-txt-ec1d1f07-9f16-4bc0-b41c-81194d82f2dc-input" class="sa-character-counter"
            style="display:none">
              0/500
            </label>
          </div>
        </div>
        <div id="sa-txt-34e64007-f24b-4e3c-b594-a12339fd21b2" data-fieldType="shortText"
        required="" data-page="1" data-field="14" class="sa-form-field">
          <p class="sa-required">
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
                City
          ...
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-txt-34e64007-f24b-4e3c-b594-a12339fd21b2-input" type="text"
            value="" required="" data-limit="255" class="sa-input sa-text" style="width:100%">
            <label for="sa-txt-34e64007-f24b-4e3c-b594-a12339fd21b2-input" class="sa-character-counter"
            style="display:none">
              0/255
            </label>
          </div>
        </div>
        <div data-fieldType="dropdown" required="" data-page="1" data-field="15"
        class="sa-form-field">
          <p class="sa-required">
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
          ...
          <select id="sa-dd-c61ee702-f57d-45b3-a9bc-3a2d12ecabf9" class="sa-input sa-text sa-dropdown sa-input-wrapper"
          style="width:30%">
            <option value="-1" disabled="" hidden="" selected="">
            </option>
            <option data-value="8f2e084b-2f32-4af0-8480-a9c63ff846ad" value="8f2e084b-2f32-4af0-8480-a9c63ff846ad">
              Alabama
            </option>
            <option data-value="9f69b55d-ce3d-4237-845f-aa6b7afeca97" value="9f69b55d-ce3d-4237-845f-aa6b7afeca97">
              Alaska
            </option>
            <option data-value="4f4f1feb-5dd8-43cf-a4b4-66ded1657f61" value="4f4f1feb-5dd8-43cf-a4b4-66ded1657f61">
              Arizona
            </option>
            <option data-value="81fef62e-e452-4c6b-881c-a63a7973a7ba" value="81fef62e-e452-4c6b-881c-a63a7973a7ba">
              Arkansas
            </option>
            <option data-value="80373360-727a-45d1-aca3-65592364a190" value="80373360-727a-45d1-aca3-65592364a190">
              California
            </option>
            <option data-value="af91e5a1-5e6c-4580-ae1f-d7154ef0ed8c" value="af91e5a1-5e6c-4580-ae1f-d7154ef0ed8c">
              Colorado
            </option>
            <option data-value="d294495b-1d45-4876-a8a6-1bb3d81eb0ab" value="d294495b-1d45-4876-a8a6-1bb3d81eb0ab">
              Connecticut
            </option>
            <option data-value="9a0e1871-040f-4f3a-930b-1aadfb0255e0" value="9a0e1871-040f-4f3a-930b-1aadfb0255e0">
              Delaware
            </option>
            <option data-value="1274e9f8-aea7-44d2-8056-14ee8ba13680" value="1274e9f8-aea7-44d2-8056-14ee8ba13680">
              District of Columbia
            </option>
            <option data-value="ed2c6af5-9adb-42f4-8cb6-aa7db36949e1" value="ed2c6af5-9adb-42f4-8cb6-aa7db36949e1">
              Florida
            </option>
            <option data-value="dadd4835-52e0-40d2-9e0e-1b0d852af3aa" value="dadd4835-52e0-40d2-9e0e-1b0d852af3aa">
              Georgia
            </option>
            <option data-value="dd6c42b0-c6f4-44e4-8456-d19c7c5a49fd" value="dd6c42b0-c6f4-44e4-8456-d19c7c5a49fd">
              Hawaii
            </option>
            <option data-value="4d296a72-3f69-4249-be58-fcfe0b5ae4f3" value="4d296a72-3f69-4249-be58-fcfe0b5ae4f3">
              Idaho
            </option>
            <option data-value="acc3ddb1-6631-4b5d-8dd9-56393f9a40ea" value="acc3ddb1-6631-4b5d-8dd9-56393f9a40ea">
              Illinois
            </option>
            <option data-value="5dda5f0c-289c-4c1e-840f-6dcb5f32f368" value="5dda5f0c-289c-4c1e-840f-6dcb5f32f368">
              Indiana
            </option>
            <option data-value="8dcbd41e-c869-40ce-952a-17f4885d3120" value="8dcbd41e-c869-40ce-952a-17f4885d3120">
              Iowa
            </option>
            <option data-value="4c8a17ad-cae6-4316-803d-d2e221713247" value="4c8a17ad-cae6-4316-803d-d2e221713247">
              Kansas
            </option>
            <option data-value="3330761a-1102-4ba1-a697-434f70a40292" value="3330761a-1102-4ba1-a697-434f70a40292">
              Kentucky
            </option>
            <option data-value="ab525ea0-4e0a-40a6-9d01-d322d7fc8d2e" value="ab525ea0-4e0a-40a6-9d01-d322d7fc8d2e">
              Louisiana
            </option>
            <option data-value="2fda888d-f721-4d49-8eef-892710b4e729" value="2fda888d-f721-4d49-8eef-892710b4e729">
              Maine
            </option>
            <option data-value="617babd9-41d6-4e11-8566-f18e716012d9" value="617babd9-41d6-4e11-8566-f18e716012d9">
              Maryland
            </option>
            <option data-value="d0e4eec3-904f-41a5-98ad-ef90d53dbd2a" value="d0e4eec3-904f-41a5-98ad-ef90d53dbd2a">
              Massachusetts
            </option>
            <option data-value="22b15341-a6a6-40de-ad0c-47e7c5131a0c" value="22b15341-a6a6-40de-ad0c-47e7c5131a0c">
              Michigan
            </option>
            <option data-value="e9a796b4-d835-4319-9943-b72d338f5e6a" value="e9a796b4-d835-4319-9943-b72d338f5e6a">
              Minnesota
            </option>
            <option data-value="9a43ff39-403a-4f9b-8a29-487990d2c38d" value="9a43ff39-403a-4f9b-8a29-487990d2c38d">
              Mississippi
            </option>
            <option data-value="1aff058d-07c5-44dd-8af3-efaecfb6b6cb" value="1aff058d-07c5-44dd-8af3-efaecfb6b6cb">
              Missouri
            </option>
            <option data-value="b030fcd3-b5e9-4a59-acf3-536d9c3566ad" value="b030fcd3-b5e9-4a59-acf3-536d9c3566ad">
              Montana
            </option>
            <option data-value="56f57fcb-d941-4ace-bb36-81f63f774341" value="56f57fcb-d941-4ace-bb36-81f63f774341">
              Nebraska
            </option>
            <option data-value="dbdf6020-82a9-426e-affd-23df53d2eb8e" value="dbdf6020-82a9-426e-affd-23df53d2eb8e">
              Nevada
            </option>
            <option data-value="b55bd246-747a-4268-8dfd-e90d58689df3" value="b55bd246-747a-4268-8dfd-e90d58689df3">
              New Hampshire
            </option>
            <option data-value="196c01a0-74f3-4392-b9d2-64dc95442354" value="196c01a0-74f3-4392-b9d2-64dc95442354">
              New Jersey
            </option>
            <option data-value="6d500502-b1ad-4f9e-a3a3-c75e9b1dc22b" value="6d500502-b1ad-4f9e-a3a3-c75e9b1dc22b">
              New Mexico
            </option>
            <option data-value="d25fbed1-cd88-473e-8e1b-d17f19b006ba" value="d25fbed1-cd88-473e-8e1b-d17f19b006ba">
              New York
            </option>
            <option data-value="df65a56f-cd3b-4899-9033-3d9cd7b2fa4a" value="df65a56f-cd3b-4899-9033-3d9cd7b2fa4a">
              North Carolina
            </option>
            <option data-value="48a1bc79-ba7e-4314-812d-a582bc5b7780" value="48a1bc79-ba7e-4314-812d-a582bc5b7780">
              North Dakota
            </option>
            <option data-value="e18cb59e-2516-4c7a-8c67-a33280463823" value="e18cb59e-2516-4c7a-8c67-a33280463823">
              Ohio
            </option>
            <option data-value="bad71576-075c-4bf5-9b73-d84d8f613c20" value="bad71576-075c-4bf5-9b73-d84d8f613c20">
              Oklahoma
            </option>
            <option data-value="97956655-3e67-4056-a0b2-a40a8494e0f9" value="97956655-3e67-4056-a0b2-a40a8494e0f9">
              Oregon
            </option>
            <option data-value="775f9c9c-8c4f-438b-ae1d-2cb7aebacf2d" value="775f9c9c-8c4f-438b-ae1d-2cb7aebacf2d">
              Pennsylvania
            </option>
            <option data-value="9c8d0210-d543-40f3-9d93-90198b480179" value="9c8d0210-d543-40f3-9d93-90198b480179">
              Rhode Island
            </option>
            <option data-value="1c7061c9-3beb-4339-a528-b251dce29024" value="1c7061c9-3beb-4339-a528-b251dce29024">
              South Carolina
            </option>
            <option data-value="09b57ba1-db10-4dff-a364-b998b6d77b89" value="09b57ba1-db10-4dff-a364-b998b6d77b89">
              South Dakota
            </option>
            <option data-value="2ed71621-cc90-41c4-aff7-dea977c3e9dd" value="2ed71621-cc90-41c4-aff7-dea977c3e9dd">
              Tennessee
            </option>
            <option data-value="6edb7fc8-7643-4e42-99cf-e9e539efad60" value="6edb7fc8-7643-4e42-99cf-e9e539efad60">
              Texas
            </option>
            <option data-value="875d6392-4892-4828-b769-ff958758861c" value="875d6392-4892-4828-b769-ff958758861c">
              Utah
            </option>
            <option data-value="3a444d32-c7c3-4bf5-bfa5-e7434dece3c7" value="3a444d32-c7c3-4bf5-bfa5-e7434dece3c7">
              Vermont
            </option>
            <option data-value="657f383f-eb84-4e3e-a798-535b1bb7f6b4" value="657f383f-eb84-4e3e-a798-535b1bb7f6b4">
              Virginia
            </option>
            <option data-value="a1821fab-4c69-4f36-8f73-64924a207b46" value="a1821fab-4c69-4f36-8f73-64924a207b46">
              Washington
            </option>
            <option data-value="b06a60c8-0c84-45a8-8866-1b54765f3dbd" value="b06a60c8-0c84-45a8-8866-1b54765f3dbd">
              West Virginia
            </option>
            <option data-value="155160f7-81b1-46c2-9046-3b8b8bc45b40" value="155160f7-81b1-46c2-9046-3b8b8bc45b40">
              Wisconsin
            </option>
            <option data-value="63573cfd-647d-4728-8b42-2dfcc71c6421" value="63573cfd-647d-4728-8b42-2dfcc71c6421">
              Wyoming
            </option>
          </select>
        </div>
        <div id="sa-txt-50b4caf0-dc95-4a76-b02f-e742c9583e27" data-fieldType="shortText"
        required="" data-page="1" data-field="16" class="sa-form-field">
          <p class="sa-required">
            <span style="color:rgb(31, 31, 31);font-family: Helvetica">
              <strong>
                Postal Code
          ...
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-txt-50b4caf0-dc95-4a76-b02f-e742c9583e27-input" type="text"
            value="" required="" data-limit="31" class="sa-input sa-text" style="width:100%">
            <label for="sa-txt-50b4caf0-dc95-4a76-b02f-e742c9583e27-input" class="sa-character-counter"
            style="display:none">
              0/31
            </label>
          </div>
        </div>
        <div data-fieldType="dropdown" required="" data-page="1" data-field="17"
        class="sa-form-field">
          <p class="sa-required">
            <strong>
              Property Type
          ...
          <select id="sa-dd-14ea8bcb-4efe-4b95-a8a7-9803b1cce213" class="sa-input sa-text sa-dropdown sa-input-wrapper"
          style="width:30%">
            <option value="-1" disabled="" hidden="" selected="">
            </option>
            <option data-value="0380d4b0-7ba7-41fa-ac9d-4119144895bc" value="0380d4b0-7ba7-41fa-ac9d-4119144895bc">
              Commercial
            </option>
            <option data-value="7c9a3955-58d0-431e-936d-81bad8dff3c1" value="7c9a3955-58d0-431e-936d-81bad8dff3c1">
              Residential
            </option>
          </select>
        </div>
        <div data-page="1" data-field="18" style="padding:0px 0px 0px 0px">
          <div class="sa-form-field sa-form-divider" style="border-bottom-style:dashed;border-bottom-width:3px;border-bottom-color:#1F1F1F">
          </div>
        </div>
        <div data-page="1" data-field="19" class="sa-form-field" style="font-size:30px">
          <strong>
            <span style="color: rgb(13, 197, 14);">
              Lawn Maintenance
            </span>
        ...
        <div data-fieldType="checklist" required="" data-page="1" data-field="20"
        class="sa-form-field">
          <p class="sa-required">
            <strong>
            ...
            <span style="font-size: 14px;">
              <br>
              Includes regular services Mowing, edging, string trimming, and blowing
              lawns keep them healthy and attractive. Customizable service schedules
              based on lawn size, grass type, and climate.
            </span>
          </p>
          <div id="sa-CL-df63a6a5-f3d2-4125-800d-10884863c843" class="sa-input-wrapper"
          style="width:60%">
            <style>
              #sa-CL-df63a6a5-f3d2-4125-800d-10884863c843 .sa-checkbox-container input:checked
              ~ .sa-checkbox {background-color:#007AFF}
            </style>
            <div class="sa-checkbox-container">
              <input type="checkbox" id="cbea28fac4-b822-41aa-96d7-f0aee3893666" value="1"
              class="sa-checkboxBtn">
              <label for="cbea28fac4-b822-41aa-96d7-f0aee3893666" data-color="#007AFF"
              class="sa-checkbox">
                <span class="sa-checkbox-checkmark">
                </span>
              </label>
              <label for="cbea28fac4-b822-41aa-96d7-f0aee3893666" class="sa-checkbox-label">
                Weekly Summer, Bi-weekly Winter | Mowing
              </label>
            </div>
            <div class="sa-checkbox-container">
              <input type="checkbox" id="cbfc201a33-05df-4780-acdb-994c95eafa19" value="4"
              class="sa-checkboxBtn">
              <label for="cbfc201a33-05df-4780-acdb-994c95eafa19" data-color="#007AFF"
              class="sa-checkbox">
                <span class="sa-checkbox-checkmark">
                </span>
              </label>
              <label for="cbfc201a33-05df-4780-acdb-994c95eafa19" class="sa-checkbox-label">
                Bi-weekly | Mowing
              </label>
            </div>
          </div>
        </div>
        <div data-fieldType="radio" required="" data-page="1" data-field="21"
        class="sa-form-field">
          <p class="sa-required">
            <strong>
              <span style="font-size: 14px;">
                Monthly | Bush &amp; Bed Maintenance
              </span>
            </strong>
            <span style="font-size: 14px;">
              <br>
              Trimming hedges &amp; shrubs **5ft &amp; below**
              <br>
              Pulling &amp; Spraying weed control
            </span>
          </p>
          <div class="sa-input-wrapper sa-multipleChoice" style="width:60%">
            <div data-color="#007AFF" data-name="sa-DivMC-e18aebe6-c60c-4a5f-a68f-f18a9865b4d3"
            class="sa-radio-container">
              <input type="radio" name="sa-MC-39f86d02-f337-451e-be90-1dc0a20b3ef1"
              id="sa-rbMC-bd0d9afa-b43e-465f-8bb8-23c09c826620" data-value="0" value="0"
              class="sa-radioBtn">
              <label for="sa-rbMC-bd0d9afa-b43e-465f-8bb8-23c09c826620" class="sa-radio">
                <span class="sa-radio-checkmark">
                </span>
              </label>
              <label for="sa-rbMC-bd0d9afa-b43e-465f-8bb8-23c09c826620" class="sa-radio-label">
                Yes
              </label>
            </div>
            <div data-color="#007AFF" data-name="sa-DivMC-e18aebe6-c60c-4a5f-a68f-f18a9865b4d3"
            class="sa-radio-container">
              <input type="radio" name="sa-MC-39f86d02-f337-451e-be90-1dc0a20b3ef1"
              id="sa-rbMC-fa51fcdf-0bbb-4478-bd56-4f3da660ed0d" data-value="1" value="1"
              class="sa-radioBtn">
              <label for="sa-rbMC-fa51fcdf-0bbb-4478-bd56-4f3da660ed0d" class="sa-radio">
                <span class="sa-radio-checkmark">
                </span>
              </label>
              <label for="sa-rbMC-fa51fcdf-0bbb-4478-bd56-4f3da660ed0d" class="sa-radio-label">
                No
              </label>
            </div>
          </div>
        </div>
        <div data-fieldType="radio" required="" data-page="1" data-field="22"
        class="sa-form-field">
          <p class="sa-required">
            <strong>
              <span style="font-size: 14px;">
                Privacy, or Tall Hedges **5ft &amp; above**
              </span>
            </strong>
            <span style="font-size: 14px;">
              <br>
          ...
          <div class="sa-input-wrapper sa-multipleChoice" style="width:60%">
            <div data-color="#007AFF" data-name="sa-DivMC-550821a8-00ea-4d6d-bee8-cd9654686140"
            class="sa-radio-container">
              <input type="radio" name="sa-MC-e3eb4f3e-0545-4272-8bb3-0e5f3815e9a4"
              id="sa-rbMC-8d06fece-8e0d-41bb-a659-8acdd73efa53" data-value="0" value="0"
              class="sa-radioBtn">
              <label for="sa-rbMC-8d06fece-8e0d-41bb-a659-8acdd73efa53" class="sa-radio">
                <span class="sa-radio-checkmark">
                </span>
              </label>
              <label for="sa-rbMC-8d06fece-8e0d-41bb-a659-8acdd73efa53" class="sa-radio-label">
                Yes
              </label>
            </div>
            <div data-color="#007AFF" data-name="sa-DivMC-550821a8-00ea-4d6d-bee8-cd9654686140"
            class="sa-radio-container">
              <input type="radio" name="sa-MC-e3eb4f3e-0545-4272-8bb3-0e5f3815e9a4"
              id="sa-rbMC-da44c322-2c8d-4f1e-930b-a3c24063e4a1" data-value="1" value="1"
              class="sa-radioBtn">
              <label for="sa-rbMC-da44c322-2c8d-4f1e-930b-a3c24063e4a1" class="sa-radio">
                <span class="sa-radio-checkmark">
                </span>
              </label>
              <label for="sa-rbMC-da44c322-2c8d-4f1e-930b-a3c24063e4a1" class="sa-radio-label">
                No
              </label>
            </div>
          </div>
        </div>
        <div id="sa-txt-61c35de8-6deb-4a20-9e8e-b7d8d43fa2a1" data-fieldType="longText"
        required="" data-page="1" data-field="23" class="sa-form-field">
          <p class="sa-required">
            <strong>
          ...
          <p>
            Feel free to include any specific details or questions related to your
            lawn maintenance requirements in this section.
          </p>
          <div class="sa-input-wrapper" style="width:30%">
            <textarea id="sa-txt-61c35de8-6deb-4a20-9e8e-b7d8d43fa2a1-input" rows="4"
            placeholder="Enter text..." required="" class="sa-input sa-textarea sa-placeholder-Helvetica"
            style="width:100%">
            </textarea>
          </div>
        </div>
        <div id="sa-dateField-d1902173-2e62-4721-9bfc-0a693d0d3143" data-fieldType="dateTime"
        required="" data-page="1" data-field="24" class="sa-form-field">
          <p class="sa-required">
            <strong>
          ...
          <p>
            Let us know your preferred date and time for service, and we'll do our
            best to accommodate your schedule.
          </p>
          <div class="sa-input-wrapper" style="width:30%">
            <input id="sa-dateField-d1902173-2e62-4721-9bfc-0a693d0d3143-input" type="text"
            value="" data-dateTimeSettings="{&quot;enableTime&quot;:false,&quot;noCalendar&quot;:false,&quot;allowInput&quot;:true,&quot;time_24hr&quot;:false,&quot;dateFormat&quot;:&quot;m-d-Y&quot;}"
            class="sa-input sa-text flatpickr sa-required" style="width:100%">
            <div id="sa-dateField-d1902173-2e62-4721-9bfc-0a693d0d3143-div">
            </div>
          </div>
        </div>
        <div data-fieldType="radio" data-page="1" data-field="25" data-jump-rules="[]"
        class="sa-form-field">
          <p>
            <label for="formItemInput3">
              <strong>
                Would you like to be notified when the job is dispatched?
              </strong>
            </label>
          </p>
          <div class="sa-input-wrapper sa-multipleChoice" style="width:60%">
            <div data-color="#007AFF" data-name="sa-DivMC-f342060b-463e-4e12-8998-f81aad50e38d"
            class="sa-radio-container">
              <input type="radio" name="sa-MC-d34ed1c6-2329-49d4-a4ec-21ec2e35d448"
              id="sa-rbMC-c84c914a-38a5-4caf-af7c-5afcd658ec00" data-value="0" value="0"
              class="sa-radioBtn">
              <label for="sa-rbMC-c84c914a-38a5-4caf-af7c-5afcd658ec00" class="sa-radio">
                <span class="sa-radio-checkmark">
                </span>
              </label>
              <label for="sa-rbMC-c84c914a-38a5-4caf-af7c-5afcd658ec00" class="sa-radio-label">
                Yes
              </label>
            </div>
            <div data-color="#007AFF" data-name="sa-DivMC-f342060b-463e-4e12-8998-f81aad50e38d"
            class="sa-radio-container">
              <input type="radio" name="sa-MC-d34ed1c6-2329-49d4-a4ec-21ec2e35d448"
              id="sa-rbMC-a99bb005-b504-4078-a1e3-0bbadce665ee" data-value="1" value="1"
              class="sa-radioBtn">
              <label for="sa-rbMC-a99bb005-b504-4078-a1e3-0bbadce665ee" class="sa-radio">
                <span class="sa-radio-checkmark">
                </span>
              </label>
              <label for="sa-rbMC-a99bb005-b504-4078-a1e3-0bbadce665ee" class="sa-radio-label">
                No
              </label>
            </div>
          </div>
        </div>
        <div data-page="1" data-field="26" class="sa-form-field">
          Once you've filled out the form, click the
          <strong>
            "Submit"
          </strong>
          button below, and we'll get in touch with you promptly to provide you
          with a customized estimate for your Lawn Service needs. Thank you for choosing
          Guardina of Orlando - A Better Outdoor Solution for your outdoor cleaning
          needs. Your satisfaction is our priority, and we look forward to serving
          you!
        </div>
        <div class="sa-ohnohoney-container">
          <input autocomplete="somethingAutofillDoesntKnow" id="customers-first-name-id"
          name="customers-first-name" type="text" class="sa-ohnohoney">
          <input autocomplete="somethingAutofillDoesntKnow" id="customers-email-id"
          name="customers-email" type="text" class="sa-ohnohoney">
        </div>
        <div class="sa-form-page-nav">
          <span id="sa-form-submit" class="sa-form-page-submit" style="height:30px;line-height:30px;background-color:#0DC50E;color:#FFFFFF;border-radius:6px">
            Submit
          </span>
        </div>
      </div>
      <div id="sa-submission-progress-container" class="sa-submission-progress-container"
      style="display:none">
        <div class="sa-submission-progress-box sa-theme1">
          <h1 class="sa-submission-progress-title">
            Submitting Form
          </h1>
          ...
          <p class="sa-submission-progress-message">
            Wait while we submit your form.
          </p>
        </div>
      </div>
    </div>
    <div id="sa-form-confirmation" class="sa-form-page sa-theme1" style="display:none">
      <div class="sa-form-confirmation-message">
        <div class="sa-form-confirmation-message-content">
